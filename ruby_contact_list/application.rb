...
.to_i
  ...
  def create_stub_data
    Contact.create("Tom", "Sav", "tomsav2010@gmail.com")
    Contact.create("Lauren","Hearnden","Lauren@gmail.com")
    Contact.create("Moo","Cow","Moo@Cow.com")
    Contact.create("Woof","Dog","Woof@Dog.com")
    Contact.create("Meow","Cat","Meow@Cat.com")
  end
